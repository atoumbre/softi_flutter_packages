...
class SupabaseResourceBase extends IResourceBase {
  ...
  @override
  IResourceAdapter<T> adapter<T extends IBaseResourceData>(
      IResource<IBaseResourceData> res) {
    return FirestoreResourceAdapter<T>(_firebaseFirestore)
      ..setResource(res as IResource<T>);
  }
