...
import 'package:softi_packages/packages/services/external/dynamic_links/i_dynamiclink_service.dart';

class FirebaseDynamiclinkService extends IDynamicLinkService {
  FirebaseDynamiclinkService(this.settings);
